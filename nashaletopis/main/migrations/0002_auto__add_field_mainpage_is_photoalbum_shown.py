...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mainpage.is_photoalbum_shown'
        db.add_column(u'main_mainpage', 'is_photoalbum_shown',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mainpage.is_photoalbum_shown'
        db.delete_column(u'main_mainpage', 'is_photoalbum_shown')
