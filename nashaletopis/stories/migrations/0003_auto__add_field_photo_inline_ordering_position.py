...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.inline_ordering_position'
        db.add_column(u'stories_photo', 'inline_ordering_position',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Photo.inline_ordering_position'
        db.delete_column(u'stories_photo', 'inline_ordering_position')
    ...
    models = {
        ...
        u'stories.photo': {
            'Meta': {'ordering': "('inline_ordering_position',)", 'object_name': 'Photo'},
