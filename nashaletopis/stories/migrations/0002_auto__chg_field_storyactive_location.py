...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StoryActive.location'
        db.alter_column(u'stories_storyactive', 'location_id', self.gf('mptt.fields.TreeForeignKey')(null=True, to=orm['locations.Location']))

    def backwards(self, orm):

        # Changing field 'StoryActive.location'
        db.alter_column(u'stories_storyactive', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['locations.Location']))
