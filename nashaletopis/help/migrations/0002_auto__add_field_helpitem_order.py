...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HelpItem.order'
        db.add_column(u'help_helpitem', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HelpItem.order'
        db.delete_column(u'help_helpitem', 'order')


    models = {
        u'help.helpitem': {
            'Meta': {'ordering': "('order',)", 'object_name': 'HelpItem'},
